...
public:
    ...
    virtual void OpenStatement(Statement& statement)= 0;
    virtual void CloseStatement(Statement& statement)= 0;
    virtual void OpenDeclaration(Declaration& declaration)= 0;
    virtual void CloseDeclaration(Declaration& declaration)= 0;
    ...
    virtual void OpenPathItem(PathItem& pathItem)= 0;
    virtual void ClosePathItem(PathItem& pathItem)= 0;
    ...
    virtual void OpenModifier(Modifier& modifier)= 0;
    virtual void CloseModifier(Modifier& modifier)= 0;
    virtual void OpenOverride(Override& override)= 0;
    virtual void CloseOverride(Override& override)= 0;
    virtual void OpenStaticWord(StaticWord& staticWord)= 0;
    virtual void CloseStaticWord(StaticWord& staticWord)= 0;
    virtual void OpenFunctionName(FunctionName& functionName)= 0;
    virtual void CloseFunctionName(FunctionName& functionName)= 0;
    virtual void OpenIdentifierFunctionName(IdentifierFunctionName& identifierFunctionName)= 0;
    virtual void CloseIdentifierFunctionName(IdentifierFunctionName& identifierFunctionName)= 0;
    ...
    virtual void OpenParameter(Parameter& parameter)= 0;
    virtual void CloseParameter(Parameter& parameter)= 0;
    ...
    virtual void OpenEnumCase(EnumCase& enumCase)= 0;
    virtual void CloseEnumCase(EnumCase& enumCase)= 0;
    ...
    virtual void OpenGenericParameter(GenericParameter& genericParameter)= 0;
    virtual void CloseGenericParameter(GenericParameter& genericParameter)= 0;
    virtual void OpenClassMember(ClassMember& classMember)= 0;
    virtual void CloseClassMember(ClassMember& classMember)= 0;
    virtual void OpenExpression(Expression& expression)= 0;
    virtual void CloseExpression(Expression& expression)= 0;
    ...
    virtual void OpenBinaryOp(BinaryOp& binaryOp)= 0;
    virtual void CloseBinaryOp(BinaryOp& binaryOp)= 0;
    ...
    virtual void OpenCatchPattern(CatchPattern& catchPattern)= 0;
    virtual void CloseCatchPattern(CatchPattern& catchPattern)= 0;
    ...
    virtual void OpenPostfix(Postfix& postfix)= 0;
    virtual void ClosePostfix(Postfix& postfix)= 0;
    virtual void OpenOperatorPostfix(OperatorPostfix& operatorPostfix)= 0;
    virtual void CloseOperatorPostfix(OperatorPostfix& operatorPostfix)= 0;
    ...
    virtual void OpenMemberPostfix(MemberPostfix& memberPostfix)= 0;
    virtual void CloseMemberPostfix(MemberPostfix& memberPostfix)= 0;
    ...
    virtual void OpenPrimaryExpression(PrimaryExpression& primaryExpression)= 0;
    virtual void ClosePrimaryExpression(PrimaryExpression& primaryExpression)= 0;
    ...
    virtual void OpenLiteralExpression(LiteralExpression& literalExpression)= 0;
    virtual void CloseLiteralExpression(LiteralExpression& literalExpression)= 0;
    virtual void OpenIdentifierExpression(IdentifierExpression& identifierExpression)= 0;
    virtual void CloseIdentifierExpression(IdentifierExpression& identifierExpression)= 0;
    ...
    virtual void OpenSwitchBody(SwitchBody& switchBody)= 0;
    virtual void CloseSwitchBody(SwitchBody& switchBody)= 0;
    ...
    virtual void OpenCaseLabel(CaseLabel& caseLabel)= 0;
    virtual void CloseCaseLabel(CaseLabel& caseLabel)= 0;
    ...
    virtual void OpenForLoop(ForLoop& forLoop)= 0;
    virtual void CloseForLoop(ForLoop& forLoop)= 0;
    ...
    virtual void OpenPattern(Pattern& pattern)= 0;
    virtual void ClosePattern(Pattern& pattern)= 0;
    virtual void OpenWildcardPattern(WildcardPattern& wildcardPattern)= 0;
    virtual void CloseWildcardPattern(WildcardPattern& wildcardPattern)= 0;
    ...
    virtual void OpenDefaultCaseLabel(DefaultCaseLabel& defaultCaseLabel)= 0;
    virtual void CloseDefaultCaseLabel(DefaultCaseLabel& defaultCaseLabel)= 0;
    virtual void OpenCaseContent(CaseContent& caseContent)= 0;
    ...
    virtual void OpenEmptyCaseContent(EmptyCaseContent& emptyCaseContent)= 0;
    virtual void CloseEmptyCaseContent(EmptyCaseContent& emptyCaseContent)= 0;
    ...
    virtual void OpenThisExpression(ThisExpression& thisExpression)= 0;
    virtual void CloseThisExpression(ThisExpression& thisExpression)= 0;
    ...
    virtual void OpenThisWord(ThisWord& thisWord)= 0;
    virtual void CloseThisWord(ThisWord& thisWord)= 0;
    virtual void OpenCommonThisMember(CommonThisMember& commonThisMember)= 0;
    virtual void CloseCommonThisMember(CommonThisMember& commonThisMember)= 0;
    virtual void OpenThisInit(ThisInit& thisInit)= 0;
    virtual void CloseThisInit(ThisInit& thisInit)= 0;
    virtual void OpenThisMember(ThisMember& thisMember)= 0;
    virtual void CloseThisMember(ThisMember& thisMember)= 0;
    virtual void OpenSuperExpression(SuperExpression& superExpression)= 0;
    virtual void CloseSuperExpression(SuperExpression& superExpression)= 0;
    ...
    virtual void OpenCommonSuperMember(CommonSuperMember& commonSuperMember)= 0;
    virtual void CloseCommonSuperMember(CommonSuperMember& commonSuperMember)= 0;
    virtual void OpenSuperInit(SuperInit& superInit)= 0;
    virtual void CloseSuperInit(SuperInit& superInit)= 0;
    virtual void OpenSuperMember(SuperMember& superMember)= 0;
    virtual void CloseSuperMember(SuperMember& superMember)= 0;
    virtual void OpenType(Type& type)= 0;
    ...
    virtual void OpenTypePostfix(TypePostfix& typePostfix)= 0;
    virtual void CloseTypePostfix(TypePostfix& typePostfix)= 0;
    virtual void OpenArrayType(ArrayType& arrayType)= 0;
    virtual void CloseArrayType(ArrayType& arrayType)= 0;
    virtual void OpenOptionalType(OptionalType& optionalType)= 0;
    virtual void CloseOptionalType(OptionalType& optionalType)= 0;
