...
_Result<BindingInitializer, ParserError> Parser::parseBindingInitializer(_Page* _rp, _Page* _ep) {
    ...
    {
        Position start = lexer.getPreviousPosition();
        _Result<Array<AdditionalInitializer>, ParserError> result = parseAdditionalInitializerList(_rp, _ep);
        if (result.succeeded()) {
            if (!ret)
                ret = new(_rp) BindingInitializer(start, lexer.getPosition());
...
_Result<Array<AdditionalInitializer>, ParserError> Parser::parseAdditionalInitializerList(_Page* _rp, _Page* _ep) {
    // Make a region for the current block and get the Page
    _Region _r; _Page* _p = _r.get();
    Array<AdditionalInitializer>* ret = 0;

    while (true) {
        _Result<AdditionalInitializer, ParserError> nodeResult = parseAdditionalInitializer(_rp, _p);
        if (nodeResult.succeeded()) {
            if (!ret)
                ret = new(_rp) Array<AdditionalInitializer>();
    ...
    return _Result<Array<AdditionalInitializer>, ParserError>(ret);
}
...
_Result<AdditionalInitializer, ParserError> Parser::parseAdditionalInitializer(_Page* _rp, _Page* _ep) {
    AdditionalInitializer* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<AdditionalInitializer, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(comma))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<InitializerDeclaration, ParserError> Parser::parseInitializerDeclaration(_Page* _rp, _Page* _ep) {
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<InitializerDeclaration, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(initKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<Override, ParserError> Parser::parseOverride(_Page* _rp, _Page* _ep) {
    Override* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<Override, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(overrideKeyword))));
        }
    }
...
_Result<ConstParameter, ParserError> Parser::parseConstParameter(_Page* _rp, _Page* _ep) {
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<ConstParameter, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(colon))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<VarParameter, ParserError> Parser::parseVarParameter(_Page* _rp, _Page* _ep) {
    VarParameter* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<VarParameter, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(mutableKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<VarParameter, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(colon))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<EnumDeclaration, ParserError> Parser::parseEnumDeclaration(_Page* _rp, _Page* _ep) {
    EnumDeclaration* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<EnumDeclaration, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(enumKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<EnumDeclaration, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(leftCurly))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
        _Result<Array<EnumMember>, ParserError> result = parseEnumMemberList(_rp, _ep);
        if (result.succeeded()) {
            if (!ret)
                ret = new(_rp) EnumDeclaration(start, lexer.getPosition());
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<EnumDeclaration, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(rightCurly))));
        }
    }
...
_Result<Array<EnumMember>, ParserError> Parser::parseEnumMemberList(_Page* _rp, _Page* _ep) {
    // Make a region for the current block and get the Page
    _Region _r; _Page* _p = _r.get();
    Array<EnumMember>* ret = 0;

    while (true) {
        _Result<EnumMember, ParserError> nodeResult = parseEnumMember(_rp, _p);
        if (nodeResult.succeeded()) {
            if (!ret)
                ret = new(_rp) Array<EnumMember>();
    ...
    return _Result<Array<EnumMember>, ParserError>(ret);
}
...
_Result<EnumMember, ParserError> Parser::parseEnumMember(_Page* _rp, _Page* _ep) {
    EnumMember* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<EnumMember, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(caseKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    {
        Position start = lexer.getPreviousPosition();
        _Result<Array<AdditionalCase>, ParserError> result = parseAdditionalCaseList(_rp, _ep);
        if (result.succeeded()) {
            if (!ret)
                ret = new(_rp) EnumMember(start, lexer.getPosition());
...
_Result<TupleType, ParserError> Parser::parseTupleType(_Page* _rp, _Page* _ep) {
    TupleType* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<TupleType, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(leftParen))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    {
        Position start = lexer.getPreviousPosition();
        _Result<Array<AdditionalType>, ParserError> result = parseAdditionalTypeList(_rp, _ep);
        if (result.succeeded()) {
            if (!ret)
                ret = new(_rp) TupleType(start, lexer.getPosition());
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<TupleType, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(rightParen))));
        }
    }
...
_Result<Array<AdditionalType>, ParserError> Parser::parseAdditionalTypeList(_Page* _rp, _Page* _ep) {
    // Make a region for the current block and get the Page
    _Region _r; _Page* _p = _r.get();
    Array<AdditionalType>* ret = 0;

    while (true) {
        _Result<AdditionalType, ParserError> nodeResult = parseAdditionalType(_rp, _p);
        if (nodeResult.succeeded()) {
            if (!ret)
                ret = new(_rp) Array<AdditionalType>();
    ...
    return _Result<Array<AdditionalType>, ParserError>(ret);
}
...
_Result<AdditionalType, ParserError> Parser::parseAdditionalType(_Page* _rp, _Page* _ep) {
    AdditionalType* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<AdditionalType, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(comma))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<Array<AdditionalCase>, ParserError> Parser::parseAdditionalCaseList(_Page* _rp, _Page* _ep) {
    // Make a region for the current block and get the Page
    _Region _r; _Page* _p = _r.get();
    Array<AdditionalCase>* ret = 0;

    while (true) {
        _Result<AdditionalCase, ParserError> nodeResult = parseAdditionalCase(_rp, _p);
        if (nodeResult.succeeded()) {
            if (!ret)
                ret = new(_rp) Array<AdditionalCase>();
    ...
    return _Result<Array<AdditionalCase>, ParserError>(ret);
}
...
_Result<AdditionalCase, ParserError> Parser::parseAdditionalCase(_Page* _rp, _Page* _ep) {
    AdditionalCase* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<AdditionalCase, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(comma))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<ClassDeclaration, ParserError> Parser::parseClassDeclaration(_Page* _rp, _Page* _ep) {
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<ClassDeclaration, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(leftCurly))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<ClassDeclaration, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(rightCurly))));
        }
    }
...
_Result<PrimaryExpression, ParserError> Parser::parsePrimaryExpression(_Page* _rp, _Page* _ep) {
...

    {
        // Make a region for the current block and get the Page
        _Region _r; _Page* _p = _r.get();
        _Result<ForEachExpression, ParserError> result = parseForEachExpression(_rp, _p);
        if (result.succeeded()) 
            return _Result<PrimaryExpression, ParserError>(result.getResult());
        else
            errors.append(result.getError());
...
_Result<ForEachExpression, ParserError> Parser::parseForEachExpression(_Page* _rp, _Page* _ep) {
    ForEachExpression* ret = 0;
    {
        Position start = lexer.getPreviousPosition();
        bool success = lexer.parseKeyword(foreachKeyword);
        if (success) {
            lexer.advance();
            if (!ret)
                ret = new(_rp) ForEachExpression(start, lexer.getPosition());
        }
        else {
            return _Result<ForEachExpression, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(foreachKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
        ...
        if (result.succeeded()) {
            ...
            return _Result<ForEachExpression, ParserError>(result.getError());
        }
    }
    {
        Position start = lexer.getPreviousPosition();
        ...
        if (success) {
            ...
            return _Result<ForEachExpression, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(inKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    return _Result<ForEachExpression, ParserError>(ret);
}
...
_Result<ForExpression, ParserError> Parser::parseForExpression(_Page* _rp, _Page* _ep) {
    ForExpression* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<ForExpression, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(forKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
    ...
    }
    {
        ...
        if (success) {
            ...
            return _Result<ForExpression, ParserError>(new(_ep) ParserError(*new(_ep) PunctuationExpected(start, *new(_ep) String(semicolon))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
...
_Result<BreakExpression, ParserError> Parser::parseBreakExpression(_Page* _rp, _Page* _ep) {
    BreakExpression* ret = 0;
    {
        ...
        if (success) {
            ...
            return _Result<BreakExpression, ParserError>(new(_ep) ParserError(*new(_ep) KeywordExpected(start, *new(_ep) String(breakKeyword))));
        }
    }
    {
        Position start = lexer.getPreviousPosition();
