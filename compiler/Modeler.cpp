...
Result<DeInitializer*, ModelError> handle_body(Page* _rp, Page* _ep, String name, String path, BodySyntax body, List<Use>& uses, HashSetBuilder<String>& modules_checker, List<Module>& modules, List<Initializer>& initializers_builder, MultiMapBuilder<String, Function>& functions_builder, Array<Member>& members_builder, HashMapBuilder<String, Nameable>& symbols_builder, String file) {
    ...
    if (body.deInit != nullptr) {
        auto _deinitializer_result = handle_deinitializer(_rp, _ep, *body.deInit, file);
...
Result<Structure, ModelError> handle_class(Page* _rp, Page* _ep, String name, String path, ClassSyntax& class_syntax, bool private_, String file) {    
    ...
    if (class_syntax.body != nullptr) {
        {
            auto _deInitializer_result = handle_body(_rp, _ep, name, path, *class_syntax.body, uses, modules_checker, modules, initializers_builder, functions_builder, members_builder, symbols_builder, file);
            if (_deInitializer_result._tag == Result<DeInitializer, ModelError>::Error)
...
Result<Union, ModelError> handle_union(Page* _rp, Page* _ep, String name, String path, UnionSyntax& union_, bool private_, String file) {    
    ...
    if (union_.body != nullptr) {
        {
            auto _deInitializer_result = handle_body(_rp, _ep, name, path, *union_.body, uses, modules_checker, modules, initializers_builder, functions_builder, members_builder, symbols_builder, file);
            if (_deInitializer_result._tag == Result<DeInitializer, ModelError>::Error)
...
Result<Constant, ModelError> handle_literal(Page* _rp, Page* _ep, LiteralSyntax& literal, String file) {
    ...
    switch (literal.literal._tag) {
        case Literal::Boolean:
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError> ::Ok, ._Ok = Constant(BooleanConstant(literal.literal._Boolean.value)) };
        case Literal::Integer: {
            ...
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError> ::Ok, ._Ok = Constant(IntegerConstant(integer)) };
        }
        case Literal::Hex: {
            ...
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError> ::Ok, ._Ok = Constant(HexConstant(hex)) };
        }
        case Literal::FloatingPoint: {
            ...
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError>::Ok, ._Ok = Constant(FloatingPointConstant(floating_point)) };
        }
        case Literal::String:
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError>::Ok, ._Ok = Constant(StringConstant(literal.literal._String.value)) };
        case Literal::Character:
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError>::Ok, ._Ok = Constant(CharacterConstant(literal.literal._Character.value)) };
        case Literal::Fragment:
            return Result<Constant, ModelError> { ._tag = Result<Constant, ModelError>::Ok, ._Ok = Constant(FragmentConstant(literal.literal._Fragment.value)) };
        break;
    }
}
...
Result<When, ModelError> handle_when(Page* _rp, Page* _ep, WhenSyntax& when_, String file) {
    ...
    auto _command_result = handle_command(_rp, _ep, when_.command, file);
