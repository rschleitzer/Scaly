...
struct Parser : Object {
    ...
    Result<PrivateSyntax, ParserError> parse_private(Page* _rp, Page* _ep) {
        ...
        auto success_private_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[28]);
    ...
    Result<UnionSyntax, ParserError> parse_union(Page* _rp, Page* _ep) {
        ...
        auto success_union_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[38]);
        if (!success_union_1) {
    ...
    Result<ReturnsSyntax, ParserError> parse_returns(Page* _rp, Page* _ep) {
        ...
        auto success_returns_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[30]);
    ...
    Result<ThrowsSyntax, ParserError> parse_throws(Page* _rp, Page* _ep) {
        ...
        auto success_throws_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[35]);
        if (!success_throws_1) {
    ...
    Result<UseSyntax, ParserError> parse_use(Page* _rp, Page* _ep) {
        ...
        auto success_use_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[39]);
        if (!success_use_1) {
    ...
    Result<ImplementSyntax, ParserError> parse_implement(Page* _rp, Page* _ep) {
        ...
        auto success_implement_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[14]);
    ...
    Result<TraitSyntax, ParserError> parse_trait(Page* _rp, Page* _ep) {
        ...
        auto success_trait_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[36]);
        if (!success_trait_1) {
    ...
    Result<InitSyntax, ParserError> parse_init(Page* _rp, Page* _ep) {
        ...
        auto success_init_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[13]);
        if (!success_init_1) {
    ...
    Result<ProcedureSyntax, ParserError> parse_procedure(Page* _rp, Page* _ep) {
        ...
        auto success_procedure_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[27]);
    ...
    Result<OperatorSyntax, ParserError> parse_operator(Page* _rp, Page* _ep) {
        ...
        auto success_operator_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[26]);
    ...
    Result<InstructionSyntax, ParserError> parse_instruction(Page* _rp, Page* _ep) {
        ...
        auto success_instruction_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[16]);
    ...
    Result<IntrinsicSyntax, ParserError> parse_intrinsic(Page* _rp, Page* _ep) {
        ...
        auto success_intrinsic_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[17]);
    ...
    Result<MacroSyntax, ParserError> parse_macro(Page* _rp, Page* _ep) {
        ...
        auto success_macro_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[22]);
        if (!success_macro_1) {
    ...
    Result<ModuleSyntax, ParserError> parse_module(Page* _rp, Page* _ep) {
        ...
        auto success_module_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[24]);
        if (!success_module_1) {
    ...
    Result<MatchSyntax, ParserError> parse_match(Page* _rp, Page* _ep) {
        ...
        auto success_match_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[23]);
        if (!success_match_1) {
    ...
    Result<TrySyntax, ParserError> parse_try(Page* _rp, Page* _ep) {
        ...
        auto success_try_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[37]);
        if (!success_try_1) {
    ...
    Result<WhenSyntax, ParserError> parse_when(Page* _rp, Page* _ep) {
        ...
        auto success_when_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[41]);
        if (!success_when_1) {
    ...
    Result<LetSyntax, ParserError> parse_let(Page* _rp, Page* _ep) {
        ...
        auto success_let_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[20]);
        if (!success_let_1) {
    ...
    Result<VarSyntax, ParserError> parse_var(Page* _rp, Page* _ep) {
        ...
        auto success_var_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[40]);
        if (!success_var_1) {
    ...
    Result<MutableSyntax, ParserError> parse_mutable(Page* _rp, Page* _ep) {
        ...
        auto success_mutable_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[25]);
    ...
    Result<LoopSyntax, ParserError> parse_loop(Page* _rp, Page* _ep) {
        ...
        auto success_loop_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[21]);
        if (!success_loop_1) {
    ...
    Result<ReturnSyntax, ParserError> parse_return(Page* _rp, Page* _ep) {
        ...
        auto success_return_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[29]);
        if (!success_return_1) {
    ...
    Result<ThrowSyntax, ParserError> parse_throw(Page* _rp, Page* _ep) {
        ...
        auto success_throw_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[34]);
        if (!success_throw_1) {
    ...
    Result<LambdaSyntax, ParserError> parse_lambda(Page* _rp, Page* _ep) {
        ...
        auto success_lambda_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[19]);
        if (!success_lambda_1) {
    ...
    Result<ForSyntax, ParserError> parse_for(Page* _rp, Page* _ep) {
        ...
        auto success_in_4 = this->lexer.parse_keyword(_rp, *this->keywords_index[15]);
        if (!success_in_4) {
    ...
    Result<LabelSyntax, ParserError> parse_label(Page* _rp, Page* _ep) {
        ...
        auto success_label_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[18]);
        if (!success_label_1) {
    ...
    Result<RepeatSyntax, ParserError> parse_repeat(Page* _rp, Page* _ep) {
        ...
        auto success_repeat_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[31]);
        if (!success_repeat_1) {
    ...
    Result<SetSyntax, ParserError> parse_set(Page* _rp, Page* _ep) {
        ...
        auto success_set_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[32]);
        if (!success_set_1) {
    ...
    Result<SizeOfSyntax, ParserError> parse_sizeof(Page* _rp, Page* _ep) {
        ...
        auto success_sizeof_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[33]);
        if (!success_sizeof_1) {
