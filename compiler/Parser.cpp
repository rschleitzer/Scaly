...
struct Parser : Object {
    ...
    Result<PrivateSyntax*, ParserError*> parse_private(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_private_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "private"));
        ...
        if (export_ == nullptr) {
            return Result<PrivateSyntax*, ParserError*> { .tag = Result<PrivateSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<DefinitionSyntax*, ParserError*> parse_definition(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_define_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "define"));
        if (!success_define_1) {
        ...
        if (type == nullptr) {
            return Result<DefinitionSyntax*, ParserError*> { .tag = Result<DefinitionSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ExtensionSyntax*, ParserError*> parse_extension(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_dot_1 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, "."));
        if (!success_dot_1) {
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<ExtensionSyntax*, ParserError*> { .tag = Result<ExtensionSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<ExtensionSyntax*, ParserError*> { .tag = Result<ExtensionSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<AttributeSyntax*, ParserError*> parse_attribute(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto attribute = this->lexer.parse_attribute(_r, _r.page);
        ...
        if (value == nullptr) {
            return Result<AttributeSyntax*, ParserError*> { .tag = Result<AttributeSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ClassSyntax*, ParserError*> parse_class(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_colon_2 = this->lexer.parse_colon(_r, _r.page);
        if (!success_colon_2) {
    ...
    Result<UnionSyntax*, ParserError*> parse_union(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_union_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "union"));
        if (!success_union_1) {
        ...
        if (!success_left_paren_3) {
            ...
            return Result<UnionSyntax*, ParserError*> { .tag = Result<UnionSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<VariantSyntax*, ParserError*> parse_variant(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_colon_1 = this->lexer.parse_colon(_r, _r.page);
        if (!success_colon_1) {
        ...
        auto structure = structure_result.ok;
        if (structure == nullptr) {
            return Result<VariantSyntax*, ParserError*> { .tag = Result<VariantSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
        ...
        auto success_colon_5 = this->lexer.parse_colon(_r, _r.page);
        if (!success_colon_5) {
    ...
    Result<EnumSyntax*, ParserError*> parse_enum(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto literal = this->lexer.parse_literal(_r, _r.page);
        if (literal == nullptr) {
    ...
    Result<DelegateSyntax*, ParserError*> parse_delegate(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_delegate_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "delegate"));
    ...
    Result<StructureSyntax*, ParserError*> parse_structure(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_left_paren_1 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, "("));
        ...
        if (!success_right_paren_3) {
            ...
            return Result<StructureSyntax*, ParserError*> { .tag = Result<StructureSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<BodySyntax*, ParserError*> parse_body(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_left_curly_1 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, "{"));
        ...
        if (!success_right_curly_3) {
            ...
            return Result<BodySyntax*, ParserError*> { .tag = Result<BodySyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<FieldSyntax*, ParserError*> parse_field(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (property == nullptr) {
            return Result<FieldSyntax*, ParserError*> { .tag = Result<FieldSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<PropertySyntax*, ParserError*> parse_property(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_comma_4 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, ","));
        if (!success_comma_4) {
    ...
    Result<TypeAnnotationSyntax*, ParserError*> parse_typeannotation(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (spec == nullptr) {
            return Result<TypeAnnotationSyntax*, ParserError*> { .tag = Result<TypeAnnotationSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ArraySyntax*, ParserError*> parse_array(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_left_bracket_1 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, "["));
        ...
        if (!success_right_bracket_3) {
            ...
            return Result<ArraySyntax*, ParserError*> { .tag = Result<ArraySyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<GenericArgumentsSyntax*, ParserError*> parse_genericarguments(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (!success_right_bracket_3) {
            ...
            return Result<GenericArgumentsSyntax*, ParserError*> { .tag = Result<GenericArgumentsSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<GenericArgumentSyntax*, ParserError*> parse_genericargument(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_comma_2 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, ","));
        if (!success_comma_2) {
    ...
    Result<OptionalSyntax*, ParserError*> parse_optional(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_question_1 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, "?"));
    ...
    Result<FunctionSyntax*, ParserError*> parse_function(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_function_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "function"));
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<FunctionSyntax*, ParserError*> { .tag = Result<FunctionSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<FunctionSyntax*, ParserError*> { .tag = Result<FunctionSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<ProcedureSyntax*, ParserError*> parse_procedure(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_procedure_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "procedure"));
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<ProcedureSyntax*, ParserError*> { .tag = Result<ProcedureSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<ProcedureSyntax*, ParserError*> { .tag = Result<ProcedureSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<OperatorSyntax*, ParserError*> parse_operator(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_operator_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "operator"));
        ...
        if (target == nullptr) {
            return Result<OperatorSyntax*, ParserError*> { .tag = Result<OperatorSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<RoutineSyntax*, ParserError*> parse_routine(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (implementation == nullptr) {
            return Result<RoutineSyntax*, ParserError*> { .tag = Result<RoutineSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<SymbolSyntax*, ParserError*> parse_symbol(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto implementation = implementation_result.ok;
        if (implementation == nullptr) {
            return Result<SymbolSyntax*, ParserError*> { .tag = Result<SymbolSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ParametersSyntax*, ParserError*> parse_parameters(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (!success_right_paren_3) {
            ...
            return Result<ParametersSyntax*, ParserError*> { .tag = Result<ParametersSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<ReturnsSyntax*, ParserError*> parse_returns(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_returns_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "returns"));
        ...
        if (parameters == nullptr) {
            return Result<ReturnsSyntax*, ParserError*> { .tag = Result<ReturnsSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ThrowsSyntax*, ParserError*> parse_throws(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_throws_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "throws"));
        if (!success_throws_1) {
        ...
        auto type = type_result.ok;
        if (type == nullptr) {
            return Result<ThrowsSyntax*, ParserError*> { .tag = Result<ThrowsSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ExternSyntax*, ParserError*> parse_extern(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_extern_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "extern"));
        if (!success_extern_1) {
    ...
    Result<InstructionSyntax*, ParserError*> parse_instruction(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_instruction_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "instruction"));
    ...
    Result<IntrinsicSyntax*, ParserError*> parse_intrinsic(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_intrinsic_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "intrinsic"));
    ...
    Result<UseSyntax*, ParserError*> parse_use(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_use_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "use"));
        if (!success_use_1) {
        ...
        auto name = name_result.ok;
        if (name == nullptr) {
            return Result<UseSyntax*, ParserError*> { .tag = Result<UseSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ImplementSyntax*, ParserError*> parse_implement(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_implement_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "implement"));
        ...
        auto type = type_result.ok;
        if (type == nullptr) {
            return Result<ImplementSyntax*, ParserError*> { .tag = Result<ImplementSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<TraitSyntax*, ParserError*> parse_trait(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_trait_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "trait"));
        if (!success_trait_1) {
        ...
        auto name = name_result.ok;
        if (name == nullptr) {
            return Result<TraitSyntax*, ParserError*> { .tag = Result<TraitSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ExtendsSyntax*, ParserError*> parse_extends(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_extends_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "extends"));
    ...
    Result<MacroSyntax*, ParserError*> parse_macro(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_macro_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "macro"));
        if (!success_macro_1) {
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<MacroSyntax*, ParserError*> { .tag = Result<MacroSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<MacroSyntax*, ParserError*> { .tag = Result<MacroSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<ModuleSyntax*, ParserError*> parse_module(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_module_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "module"));
        if (!success_module_1) {
        ...
        auto name = name_result.ok;
        if (name == nullptr) {
            return Result<ModuleSyntax*, ParserError*> { .tag = Result<ModuleSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<LetSyntax*, ParserError*> parse_let(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_let_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "let"));
        if (!success_let_1) {
        ...
        if (binding == nullptr) {
            return Result<LetSyntax*, ParserError*> { .tag = Result<LetSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<VarSyntax*, ParserError*> parse_var(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_var_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "var"));
        if (!success_var_1) {
        ...
        auto binding = binding_result.ok;
        if (binding == nullptr) {
            return Result<VarSyntax*, ParserError*> { .tag = Result<VarSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<MutableSyntax*, ParserError*> parse_mutable(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_mutable_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "mutable"));
        ...
        auto binding = binding_result.ok;
        if (binding == nullptr) {
            return Result<MutableSyntax*, ParserError*> { .tag = Result<MutableSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<BindingSyntax*, ParserError*> parse_binding(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto operation = operation_result.ok;
        if (operation == nullptr) {
            return Result<BindingSyntax*, ParserError*> { .tag = Result<BindingSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<BindingAnnotationSyntax*, ParserError*> parse_bindingannotation(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto spec = spec_result.ok;
        if (spec == nullptr) {
            return Result<BindingAnnotationSyntax*, ParserError*> { .tag = Result<BindingAnnotationSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<SetSyntax*, ParserError*> parse_set(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_set_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "set"));
        if (!success_set_1) {
        ...
        auto target = target_result.ok;
        if (target == nullptr) {
            return Result<SetSyntax*, ParserError*> { .tag = Result<SetSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<MemberAccessSyntax*, ParserError*> parse_memberaccess(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (member == nullptr) {
            return Result<MemberAccessSyntax*, ParserError*> { .tag = Result<MemberAccessSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<CatchSyntax*, ParserError*> parse_catch(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_catch_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "catch"));
        if (!success_catch_1) {
        ...
        if (condition == nullptr) {
            return Result<CatchSyntax*, ParserError*> { .tag = Result<CatchSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<DropSyntax*, ParserError*> parse_drop(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_drop_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "drop"));
        if (!success_drop_1) {
        ...
        auto handler = handler_result.ok;
        if (handler == nullptr) {
            return Result<DropSyntax*, ParserError*> { .tag = Result<DropSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ContinueSyntax*, ParserError*> parse_continue(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_continue_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "continue"));
    ...
    Result<LoopSyntax*, ParserError*> parse_loop(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_loop_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "loop"));
        if (!success_loop_1) {
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<LoopSyntax*, ParserError*> { .tag = Result<LoopSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<LoopSyntax*, ParserError*> { .tag = Result<LoopSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<BreakSyntax*, ParserError*> parse_break(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_break_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "break"));
        if (!success_break_1) {
    ...
    Result<ReturnSyntax*, ParserError*> parse_return(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_return_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "return"));
        if (!success_return_1) {
    ...
    Result<ThrowSyntax*, ParserError*> parse_throw(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_throw_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "throw"));
        if (!success_throw_1) {
    ...
    Result<ObjectSyntax*, ParserError*> parse_object(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (!success_right_paren_3) {
            ...
            return Result<ObjectSyntax*, ParserError*> { .tag = Result<ObjectSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<ValueSyntax*, ParserError*> parse_value(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto value = value_result.ok;
        if (value == nullptr) {
            return Result<ValueSyntax*, ParserError*> { .tag = Result<ValueSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<VectorSyntax*, ParserError*> parse_vector(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (elements == nullptr) {
            return Result<VectorSyntax*, ParserError*> { .tag = Result<VectorSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ElementSyntax*, ParserError*> parse_element(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_comma_3 = this->lexer.parse_punctuation(_r, _r.page, *String::from_c_string(_r.page, ","));
        if (!success_comma_3) {
    ...
    Result<BlockSyntax*, ParserError*> parse_block(Region& _pr, Page* _rp, Page* _ep) {
        ...
        if (!success_right_curly_3) {
            ...
            return Result<BlockSyntax*, ParserError*> { .tag = Result<BlockSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };        }
    ...
    Result<IfSyntax*, ParserError*> parse_if(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_if_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "if"));
        if (!success_if_1) {
        ...
        auto condition = condition_result.ok;
        if (condition == nullptr) {
            return Result<IfSyntax*, ParserError*> { .tag = Result<IfSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<IsSyntax*, ParserError*> parse_is(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_is_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "is"));
        if (!success_is_1) {
        ...
        auto type = type_result.ok;
        if (type == nullptr) {
            return Result<IsSyntax*, ParserError*> { .tag = Result<IsSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<AsSyntax*, ParserError*> parse_as(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_as_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "as"));
        if (!success_as_1) {
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<AsSyntax*, ParserError*> { .tag = Result<AsSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<AsSyntax*, ParserError*> { .tag = Result<AsSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<ElseSyntax*, ParserError*> parse_else(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_else_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "else"));
        if (!success_else_1) {
        ...
        if (alternative == nullptr) {
            return Result<ElseSyntax*, ParserError*> { .tag = Result<ElseSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<MatchSyntax*, ParserError*> parse_match(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_match_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "match"));
        if (!success_match_1) {
        ...
        if (scrutinee == nullptr) {
            return Result<MatchSyntax*, ParserError*> { .tag = Result<MatchSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<CaseSyntax*, ParserError*> parse_case(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_case_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "case"));
        if (!success_case_1) {
        ...
        auto condition = condition_result.ok;
        if (condition == nullptr) {
            return Result<CaseSyntax*, ParserError*> { .tag = Result<CaseSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<DefaultSyntax*, ParserError*> parse_default(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_default_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "default"));
    ...
    Result<LambdaSyntax*, ParserError*> parse_lambda(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_lambda_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "lambda"));
        if (!success_lambda_1) {
        ...
        if (input == nullptr) {
            return Result<LambdaSyntax*, ParserError*> { .tag = Result<LambdaSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<ForSyntax*, ParserError*> parse_for(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_for_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "for"));
        if (!success_for_1) {
        ...
        auto condition = condition_result.ok;
        if (condition == nullptr) {
            return Result<ForSyntax*, ParserError*> { .tag = Result<ForSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<LabelSyntax*, ParserError*> parse_label(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_label_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "label"));
        if (!success_label_1) {
        ...
        if (name != nullptr) {
            if (!this->is_identifier(*name)) {
            return Result<LabelSyntax*, ParserError*> { .tag = Result<LabelSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
            }
        }
        else {
            return Result<LabelSyntax*, ParserError*> { .tag = Result<LabelSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
    ...
    Result<WhileSyntax*, ParserError*> parse_while(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_while_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "while"));
        if (!success_while_1) {
        ...
        auto condition = condition_result.ok;
        if (condition == nullptr) {
            return Result<WhileSyntax*, ParserError*> { .tag = Result<WhileSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<RepeatSyntax*, ParserError*> parse_repeat(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_repeat_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "repeat"));
        if (!success_repeat_1) {
        ...
        auto action = action_result.ok;
        if (action == nullptr) {
            return Result<RepeatSyntax*, ParserError*> { .tag = Result<RepeatSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
    ...
    Result<SizeOfSyntax*, ParserError*> parse_sizeof(Region& _pr, Page* _rp, Page* _ep) {
        ...
        auto success_sizeof_1 = this->lexer.parse_keyword(_r, _r.page, *String::from_c_string(_r.page, "sizeof"));
        if (!success_sizeof_1) {
        ...
        auto type = type_result.ok;
        if (type == nullptr) {
            return Result<SizeOfSyntax*, ParserError*> { .tag = Result<SizeOfSyntax*, ParserError*>::Error, .error = new(alignof(ParserError), _ep) ParserError(*text.copy(_ep), start, lexer.position) };
        }
