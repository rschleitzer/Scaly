...
struct Parser : Object {
    ...
    Result<FileSyntax*, ParserError*> parse_file(Page* _rp, Page* _ep, String& file_name) {

        auto declarations_result = parse_declaration_list(_rp, _ep);
        ...
        auto statements_result = parse_statement_list(_rp, _ep);
    ...
    Result<Vector<DeclarationSyntax>*, ParserError*> parse_declaration_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<DeclarationSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<PrivateSyntax*, ParserError*> parse_private(Page* _rp, Page* _ep) {
        ...
        auto success_private_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "private"));
        if (!success_private_1) {

                return Result<PrivateSyntax*, ParserError*> { .tag = Result<PrivateSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto export__result = parse_export(_rp, _ep);
    ...
    Result<DefinitionSyntax*, ParserError*> parse_definition(Page* _rp, Page* _ep) {
        ...
        auto success_define_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "define"));
        if (!success_define_1) {

                return Result<DefinitionSyntax*, ParserError*> { .tag = Result<DefinitionSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto type_result = parse_type(_rp, _ep);
        ...
        auto success_colon_3 = this->lexer.parse_colon(r.page);
        if (!success_colon_3) {

        }

        auto attributes_result = parse_attribute_list(_rp, _ep);
        ...
        auto concept__result = parse_concept(_rp, _ep);
    ...
    Result<NameSyntax*, ParserError*> parse_name(Page* _rp, Page* _ep) {
        ...
        auto name = this->lexer.parse_identifier(r.page, this->keywords);
        if (name != nullptr) {
        ...
        auto extensions_result = parse_extension_list(_rp, _ep);
    ...
    Result<Vector<ExtensionSyntax>*, ParserError*> parse_extension_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<ExtensionSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<ExtensionSyntax*, ParserError*> parse_extension(Page* _rp, Page* _ep) {
        ...
        auto success_dot_1 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "."));
        if (!success_dot_1) {
    ...
    Result<Vector<AttributeSyntax>*, ParserError*> parse_attribute_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<AttributeSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<ClassSyntax*, ParserError*> parse_class(Page* _rp, Page* _ep) {
        ...
        auto structure_result = parse_structure(_rp, _ep);
        ...
        auto success_colon_2 = this->lexer.parse_colon(r.page);
        if (!success_colon_2) {

        }

        auto body_result = parse_body(_rp, _ep);
    ...
    Result<UnionSyntax*, ParserError*> parse_union(Page* _rp, Page* _ep) {
        ...
        auto success_union_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "union"));
        if (!success_union_1) {
        ...
        auto success_left_paren_3 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "("));
        ...
        auto tags_result = parse_tag_list(_rp, _ep);
        ...
        auto success_right_paren_5 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, ")"));
        ...
        auto success_colon_6 = this->lexer.parse_colon(r.page);
        if (!success_colon_6) {
    ...
    Result<Vector<TagSyntax>*, ParserError*> parse_tag_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<TagSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<TagSyntax*, ParserError*> parse_tag(Page* _rp, Page* _ep) {
        ...
        auto item_result = parse_item(_rp, _ep);
    ...
    Result<VariantSyntax*, ParserError*> parse_variant(Page* _rp, Page* _ep) {
        ...
        auto success_colon_1 = this->lexer.parse_colon(r.page);
        if (!success_colon_1) {
        ...
        auto success_colon_5 = this->lexer.parse_colon(r.page);
        if (!success_colon_5) {
    ...
    Result<EnumSyntax*, ParserError*> parse_enum(Page* _rp, Page* _ep) {
        ...
        auto literal = this->lexer.parse_literal(r.page);
        if (literal == nullptr) {
    ...
    Result<ConstantSyntax*, ParserError*> parse_constant(Page* _rp, Page* _ep) {
        ...
        auto operation_result = parse_operation(_rp, _ep);
    ...
    Result<DelegateSyntax*, ParserError*> parse_delegate(Page* _rp, Page* _ep) {
        ...
        auto success_delegate_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "delegate"));
        if (!success_delegate_1) {

                return Result<DelegateSyntax*, ParserError*> { .tag = Result<DelegateSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto parameters_result = parse_parameterset(_rp, _ep);
        ...
        auto result_result = parse_returns(_rp, _ep);
        ...
        auto error_result = parse_throws(_rp, _ep);
    ...
    Result<StructureSyntax*, ParserError*> parse_structure(Page* _rp, Page* _ep) {
        ...
        auto success_left_paren_1 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "("));
        if (!success_left_paren_1) {

                return Result<StructureSyntax*, ParserError*> { .tag = Result<StructureSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto members_result = parse_member_list(_rp, _ep);
        ...
        auto success_right_paren_3 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, ")"));
    ...
    Result<BodySyntax*, ParserError*> parse_body(Page* _rp, Page* _ep) {
        ...
        auto success_left_curly_1 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "{"));
        ...
        auto success_right_curly_3 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "}"));
        ...
        auto success_colon_4 = this->lexer.parse_colon(r.page);
        if (!success_colon_4) {
    ...
    Result<Vector<MemberSyntax>*, ParserError*> parse_member_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<MemberSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<FieldSyntax*, ParserError*> parse_field(Page* _rp, Page* _ep) {
        ...
        auto property_result = parse_property(_rp, _ep);
    ...
    Result<Vector<PropertySyntax>*, ParserError*> parse_property_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<PropertySyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<PropertySyntax*, ParserError*> parse_property(Page* _rp, Page* _ep) {
        ...
        auto annotation_result = parse_typeannotation(_rp, _ep);
        ...
        auto success_comma_4 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, ","));
        if (!success_comma_4) {
    ...
    Result<TypeAnnotationSyntax*, ParserError*> parse_typeannotation(Page* _rp, Page* _ep) {
        ...
        auto spec_result = parse_typespec(_rp, _ep);
    ...
    Result<Vector<TypeSpecSyntax>*, ParserError*> parse_typespec_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            auto r_1 = Region::create(r);
            Array<TypeSpecSyntax>* array = nullptr;
            while(true) {
                auto node_result = this->parse_typespec(_rp, _ep);
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<TypeSpecSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<TypeSpecSyntax*, ParserError*> parse_typespec(Page* _rp, Page* _ep) {
        {
    ...
    Result<TypeSyntax*, ParserError*> parse_type(Page* _rp, Page* _ep) {
        ...
        auto name_result = parse_name(_rp, _ep);
        ...
        auto generics_result = parse_genericarguments(_rp, _ep);
        ...
        auto optional_result = parse_optional(_rp, _ep);
    ...
    Result<ArraySyntax*, ParserError*> parse_array(Page* _rp, Page* _ep) {
        ...
        auto success_left_bracket_1 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "["));
        if (!success_left_bracket_1) {

                return Result<ArraySyntax*, ParserError*> { .tag = Result<ArraySyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto members_result = parse_typespec_list(_rp, _ep);
        ...
        auto success_right_bracket_3 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "]"));
    ...
    Result<GenericArgumentsSyntax*, ParserError*> parse_genericarguments(Page* _rp, Page* _ep) {
        ...
        auto generics_result = parse_genericargument_list(_rp, _ep);
    ...
    Result<Vector<GenericArgumentSyntax>*, ParserError*> parse_genericargument_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<GenericArgumentSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<GenericArgumentSyntax*, ParserError*> parse_genericargument(Page* _rp, Page* _ep) {
        ...
        auto spec_result = parse_type(_rp, _ep);
        ...
        auto success_comma_2 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, ","));
        if (!success_comma_2) {
    ...
    Result<OptionalSyntax*, ParserError*> parse_optional(Page* _rp, Page* _ep) {
        ...
        auto success_question_1 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "?"));
    ...
    Result<FunctionSyntax*, ParserError*> parse_function(Page* _rp, Page* _ep) {
        ...
        auto success_function_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "function"));
        ...
        auto routine_result = parse_routine(_rp, _ep);
    ...
    Result<ProcedureSyntax*, ParserError*> parse_procedure(Page* _rp, Page* _ep) {
        ...
        auto success_procedure_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "procedure"));
    ...
    Result<OperatorSyntax*, ParserError*> parse_operator(Page* _rp, Page* _ep) {
        ...
        auto success_operator_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "operator"));
        if (!success_operator_1) {

                return Result<OperatorSyntax*, ParserError*> { .tag = Result<OperatorSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto target_result = parse_target(_rp, _ep);
    ...
    Result<RoutineSyntax*, ParserError*> parse_routine(Page* _rp, Page* _ep) {
        ...
        auto returns_result = parse_returns(_rp, _ep);
        ...
        auto throws_result = parse_throws(_rp, _ep);
        ...
        auto implementation_result = parse_implementation(_rp, _ep);
    ...
    Result<ParametersSyntax*, ParserError*> parse_parameters(Page* _rp, Page* _ep) {
        ...
        auto properties_result = parse_property_list(_rp, _ep);
    ...
    Result<ReturnsSyntax*, ParserError*> parse_returns(Page* _rp, Page* _ep) {
        ...
        auto success_returns_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "returns"));
    ...
    Result<ThrowsSyntax*, ParserError*> parse_throws(Page* _rp, Page* _ep) {
        ...
        auto success_throws_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "throws"));
        if (!success_throws_1) {
    ...
    Result<Vector<ActionSyntax>*, ParserError*> parse_action_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<ActionSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<ExternSyntax*, ParserError*> parse_extern(Page* _rp, Page* _ep) {
        ...
        auto success_extern_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "extern"));
        if (!success_extern_1) {
    ...
    Result<InstructionSyntax*, ParserError*> parse_instruction(Page* _rp, Page* _ep) {
        ...
        auto success_instruction_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "instruction"));
    ...
    Result<IntrinsicSyntax*, ParserError*> parse_intrinsic(Page* _rp, Page* _ep) {
        ...
        auto success_intrinsic_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "intrinsic"));
    ...
    Result<UseSyntax*, ParserError*> parse_use(Page* _rp, Page* _ep) {
        ...
        auto success_use_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "use"));
        if (!success_use_1) {
    ...
    Result<ImplementSyntax*, ParserError*> parse_implement(Page* _rp, Page* _ep) {
        ...
        auto success_implement_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "implement"));
        ...
        auto success_left_curly_5 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "{"));
        ...
        auto methods_result = parse_method_list(_rp, _ep);
        ...
        auto success_right_curly_7 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, "}"));
        ...
        auto success_colon_8 = this->lexer.parse_colon(r.page);
        if (!success_colon_8) {
    ...
    Result<TraitSyntax*, ParserError*> parse_trait(Page* _rp, Page* _ep) {
        ...
        auto success_trait_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "trait"));
        if (!success_trait_1) {
        ...
        auto extension_result = parse_extends(_rp, _ep);
        ...
        auto functions_result = parse_method_list(_rp, _ep);
    ...
    Result<Vector<MethodSyntax>*, ParserError*> parse_method_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<MethodSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<ExtendsSyntax*, ParserError*> parse_extends(Page* _rp, Page* _ep) {
        ...
        auto success_extends_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "extends"));
        if (!success_extends_1) {

                return Result<ExtendsSyntax*, ParserError*> { .tag = Result<ExtendsSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto extensions_result = parse_extend_list(_rp, _ep);
    ...
    Result<Vector<ExtendSyntax>*, ParserError*> parse_extend_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<ExtendSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<MacroSyntax*, ParserError*> parse_macro(Page* _rp, Page* _ep) {
        ...
        auto success_macro_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "macro"));
        if (!success_macro_1) {
        ...
        auto model_result = parse_model(_rp, _ep);
        ...
        auto rule_result = parse_operation(_rp, _ep);
    ...
    Result<ModuleSyntax*, ParserError*> parse_module(Page* _rp, Page* _ep) {
        ...
        auto success_module_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "module"));
        if (!success_module_1) {
    ...
    Result<Vector<StatementSyntax>*, ParserError*> parse_statement_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<StatementSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<LetSyntax*, ParserError*> parse_let(Page* _rp, Page* _ep) {
        ...
        auto success_let_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "let"));
        if (!success_let_1) {

                return Result<LetSyntax*, ParserError*> { .tag = Result<LetSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto binding_result = parse_binding(_rp, _ep);
    ...
    Result<VarSyntax*, ParserError*> parse_var(Page* _rp, Page* _ep) {
        ...
        auto success_var_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "var"));
        if (!success_var_1) {
    ...
    Result<MutableSyntax*, ParserError*> parse_mutable(Page* _rp, Page* _ep) {
        ...
        auto success_mutable_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "mutable"));
    ...
    Result<BindingSyntax*, ParserError*> parse_binding(Page* _rp, Page* _ep) {
        ...
        auto annotation_result = parse_bindingannotation(_rp, _ep);
    ...
    Result<BindingAnnotationSyntax*, ParserError*> parse_bindingannotation(Page* _rp, Page* _ep) {
        ...
        auto spec_result = parse_bindingspec(_rp, _ep);
    ...
    Result<Vector<BindingSpecSyntax>*, ParserError*> parse_bindingspec_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<BindingSpecSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<SetSyntax*, ParserError*> parse_set(Page* _rp, Page* _ep) {
        ...
        auto success_set_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "set"));
        if (!success_set_1) {

                return Result<SetSyntax*, ParserError*> { .tag = Result<SetSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto target_result = parse_operation(_rp, _ep);
        ...
        auto source_result = parse_operation(_rp, _ep);
    ...
    Result<OperationSyntax*, ParserError*> parse_operation(Page* _rp, Page* _ep) {
        ...
        auto operands_result = parse_operand_list(_rp, _ep);
    ...
    Result<Vector<OperandSyntax>*, ParserError*> parse_operand_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<OperandSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<OperandSyntax*, ParserError*> parse_operand(Page* _rp, Page* _ep) {
        ...
        auto expression_result = parse_expression(_rp, _ep);
        ...
        auto postfixes_result = parse_postfix_list(_rp, _ep);
    ...
    Result<Vector<PostfixSyntax>*, ParserError*> parse_postfix_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<PostfixSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<MemberAccessSyntax*, ParserError*> parse_memberaccess(Page* _rp, Page* _ep) {
        ...
        auto member_result = parse_name(_rp, _ep);
    ...
    Result<CatcherSyntax*, ParserError*> parse_catcher(Page* _rp, Page* _ep) {
        ...
        auto catchers_result = parse_catch_list(_rp, _ep);
        ...
        auto dropper_result = parse_drop(_rp, _ep);
    ...
    Result<Vector<CatchSyntax>*, ParserError*> parse_catch_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<CatchSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<CatchSyntax*, ParserError*> parse_catch(Page* _rp, Page* _ep) {
        ...
        auto success_catch_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "catch"));
        if (!success_catch_1) {

                return Result<CatchSyntax*, ParserError*> { .tag = Result<CatchSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto condition_result = parse_operation(_rp, _ep);
        ...
        auto handler_result = parse_operation(_rp, _ep);
    ...
    Result<DropSyntax*, ParserError*> parse_drop(Page* _rp, Page* _ep) {
        ...
        auto success_drop_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "drop"));
        if (!success_drop_1) {
    ...
    Result<ContinueSyntax*, ParserError*> parse_continue(Page* _rp, Page* _ep) {
        ...
        auto success_continue_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "continue"));
        if (!success_continue_1) {

                return Result<ContinueSyntax*, ParserError*> { .tag = Result<ContinueSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto name_result = parse_loop(_rp, _ep);
    ...
    Result<LoopSyntax*, ParserError*> parse_loop(Page* _rp, Page* _ep) {
        ...
        auto success_loop_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "loop"));
        if (!success_loop_1) {
    ...
    Result<BreakSyntax*, ParserError*> parse_break(Page* _rp, Page* _ep) {
        ...
        auto success_break_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "break"));
        if (!success_break_1) {
        ...
        auto result_result = parse_operation(_rp, _ep);
    ...
    Result<ReturnSyntax*, ParserError*> parse_return(Page* _rp, Page* _ep) {
        ...
        auto success_return_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "return"));
        if (!success_return_1) {
    ...
    Result<ThrowSyntax*, ParserError*> parse_throw(Page* _rp, Page* _ep) {
        ...
        auto success_throw_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "throw"));
        if (!success_throw_1) {
    ...
    Result<ObjectSyntax*, ParserError*> parse_object(Page* _rp, Page* _ep) {
        ...
        auto components_result = parse_component_list(_rp, _ep);
    ...
    Result<Vector<ComponentSyntax>*, ParserError*> parse_component_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<ComponentSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<ComponentSyntax*, ParserError*> parse_component(Page* _rp, Page* _ep) {
        ...
        auto value_result = parse_value(_rp, _ep);
    ...
    Result<ValueSyntax*, ParserError*> parse_value(Page* _rp, Page* _ep) {
        ...
        auto value_result = parse_operation(_rp, _ep);
    ...
    Result<VectorSyntax*, ParserError*> parse_vector(Page* _rp, Page* _ep) {
        ...
        auto elements_result = parse_element_list(_rp, _ep);
    ...
    Result<Vector<ElementSyntax>*, ParserError*> parse_element_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<ElementSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<ElementSyntax*, ParserError*> parse_element(Page* _rp, Page* _ep) {
        ...
        auto success_comma_3 = this->lexer.parse_punctuation(r.page, *String::from_c_string(r.page, ","));
        if (!success_comma_3) {
    ...
    Result<IfSyntax*, ParserError*> parse_if(Page* _rp, Page* _ep) {
        ...
        auto success_if_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "if"));
        if (!success_if_1) {
        ...
        auto match_result = parse_is(_rp, _ep);
        ...
        auto alias_result = parse_as(_rp, _ep);
        ...
        auto consequent_result = parse_action(_rp, _ep);
        ...
        auto alternative_result = parse_else(_rp, _ep);
    ...
    Result<IsSyntax*, ParserError*> parse_is(Page* _rp, Page* _ep) {
        ...
        auto success_is_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "is"));
        if (!success_is_1) {
    ...
    Result<AsSyntax*, ParserError*> parse_as(Page* _rp, Page* _ep) {
        ...
        auto success_as_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "as"));
        if (!success_as_1) {
    ...
    Result<ElseSyntax*, ParserError*> parse_else(Page* _rp, Page* _ep) {
        ...
        auto success_else_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "else"));
        if (!success_else_1) {
        ...
        auto alternative_result = parse_action(_rp, _ep);
    ...
    Result<MatchSyntax*, ParserError*> parse_match(Page* _rp, Page* _ep) {
        ...
        auto success_match_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "match"));
        if (!success_match_1) {

                return Result<MatchSyntax*, ParserError*> { .tag = Result<MatchSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto scrutinee_result = parse_operation(_rp, _ep);
        ...
        auto cases_result = parse_case_list(_rp, _ep);
        ...
        auto alternative_result = parse_default(_rp, _ep);
    ...
    Result<Vector<CaseSyntax>*, ParserError*> parse_case_list(Page* _rp, Page* _ep) {
        auto r = Region::create_from_page(_rp);
        {
            ...
            while(true) {
                ...
                if (node != nullptr) {
                    if (array == nullptr)
                        array = Array<CaseSyntax>::create(r_1.page);
                    array->add(*node);
                } else {
                    break;
                }
    ...
    Result<CaseSyntax*, ParserError*> parse_case(Page* _rp, Page* _ep) {
        ...
        auto success_case_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "case"));
        if (!success_case_1) {
    ...
    Result<DefaultSyntax*, ParserError*> parse_default(Page* _rp, Page* _ep) {
        ...
        auto success_default_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "default"));
    ...
    Result<LambdaSyntax*, ParserError*> parse_lambda(Page* _rp, Page* _ep) {
        ...
        auto success_lambda_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "lambda"));
        if (!success_lambda_1) {

                return Result<LambdaSyntax*, ParserError*> { .tag = Result<LambdaSyntax*, ParserError*>::Ok, .ok = nullptr };
        }

        auto input_result = parse_operation(_rp, _ep);
        ...
        auto block_result = parse_action(_rp, _ep);
    ...
    Result<ForSyntax*, ParserError*> parse_for(Page* _rp, Page* _ep) {
        ...
        auto success_for_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "for"));
        if (!success_for_1) {
        ...
        auto success_in_3 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "in"));
        if (!success_in_3) {
        ...
        auto expression_result = parse_operation(_rp, _ep);
        ...
        auto name_result = parse_label(_rp, _ep);
        ...
        auto action_result = parse_action(_rp, _ep);
    ...
    Result<LabelSyntax*, ParserError*> parse_label(Page* _rp, Page* _ep) {
        ...
        auto success_label_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "label"));
        if (!success_label_1) {
    ...
    Result<WhileSyntax*, ParserError*> parse_while(Page* _rp, Page* _ep) {
        ...
        auto success_while_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "while"));
        if (!success_while_1) {
    ...
    Result<RepeatSyntax*, ParserError*> parse_repeat(Page* _rp, Page* _ep) {
        ...
        auto success_repeat_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "repeat"));
        if (!success_repeat_1) {
    ...
    Result<SizeOfSyntax*, ParserError*> parse_sizeof(Page* _rp, Page* _ep) {
        ...
        auto success_sizeof_1 = this->lexer.parse_keyword(r.page, *String::from_c_string(r.page, "sizeof"));
        if (!success_sizeof_1) {
