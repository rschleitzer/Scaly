...
struct IsSyntax : Object {
    IsSyntax(size_t start, size_t end, NameSyntax name) : start(start), end(end), name(name) {}
    size_t start;
    size_t end;
    NameSyntax name;
};
...
struct TrySyntax : Object {
    TrySyntax(size_t start, size_t end, ConditionSyntax condition, Vector<WhenSyntax>* cases, ElseSyntax* dropper) : start(start), end(end), condition(condition), cases(cases), dropper(dropper) {}
    size_t start;
    size_t end;
...
struct ChooseSyntax : Object {
    ChooseSyntax(size_t start, size_t end, Vector<OperandSyntax>* condition, Vector<WhenSyntax>* cases, ElseSyntax* alternative) : start(start), end(end), condition(condition), cases(cases), alternative(alternative) {}
    size_t start;
    size_t end;
...
struct CaseSyntax : Object {
    CaseSyntax(size_t start, size_t end, Vector<OperandSyntax>* condition) : start(start), end(end), condition(condition) {}
    size_t start;
    size_t end;
    Vector<OperandSyntax>* condition;
};
...
struct BranchSyntax : Object {
    BranchSyntax(size_t start, size_t end, Vector<CaseSyntax>* cases, StatementSyntax consequent) : start(start), end(end), cases(cases), consequent(consequent) {}
    size_t start;
    size_t end;
...
struct MatchSyntax : Object {
    MatchSyntax(size_t start, size_t end, Vector<OperandSyntax>* scrutinee, Vector<BranchSyntax>* branches, ElseSyntax* alternative) : start(start), end(end), scrutinee(scrutinee), branches(branches), alternative(alternative) {}
    size_t start;
    size_t end;
...
struct ExpressionSyntax : Object {
    ...
    ExpressionSyntax(IsSyntax _IsSyntax) : _tag(Is) { _Is = _IsSyntax; }
    enum {
        Literal,
        Type,
        Object,
...
struct Parser : Object {
    ...
    Result<PrivateSyntax, ParserError> parse_private(Page* _rp, Page* _ep) {
        ...
        auto success_private_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[29]);
    ...
    Result<DelegateSyntax, ParserError> parse_delegate(Page* _rp, Page* _ep) {
        ...
        auto success_delegate_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[6]);
    ...
    Result<ReturnsSyntax, ParserError> parse_returns(Page* _rp, Page* _ep) {
        ...
        auto success_returns_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[31]);
    ...
    Result<ThrowsSyntax, ParserError> parse_throws(Page* _rp, Page* _ep) {
        ...
        auto success_throws_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[36]);
        if (!success_throws_1) {
    ...
    Result<ImplementSyntax, ParserError> parse_implement(Page* _rp, Page* _ep) {
        ...
        auto success_implement_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[15]);
    ...
    Result<TraitSyntax, ParserError> parse_trait(Page* _rp, Page* _ep) {
        ...
        auto success_trait_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[37]);
        if (!success_trait_1) {
    ...
    Result<InitSyntax, ParserError> parse_init(Page* _rp, Page* _ep) {
        ...
        auto success_init_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[14]);
        if (!success_init_1) {
    ...
    Result<DeInitSyntax, ParserError> parse_deinit(Page* _rp, Page* _ep) {
        ...
        auto success_deinit_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[5]);
        if (!success_deinit_1) {
    ...
    Result<FunctionSyntax, ParserError> parse_function(Page* _rp, Page* _ep) {
        ...
        auto success_function_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[11]);
    ...
    Result<ProcedureSyntax, ParserError> parse_procedure(Page* _rp, Page* _ep) {
        ...
        auto success_procedure_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[28]);
    ...
    Result<OperatorSyntax, ParserError> parse_operator(Page* _rp, Page* _ep) {
        ...
        auto success_operator_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[27]);
    ...
    Result<ExternSyntax, ParserError> parse_extern(Page* _rp, Page* _ep) {
        ...
        auto success_extern_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[9]);
        if (!success_extern_1) {
    ...
    Result<InstructionSyntax, ParserError> parse_instruction(Page* _rp, Page* _ep) {
        ...
        auto success_instruction_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[17]);
    ...
    Result<IntrinsicSyntax, ParserError> parse_intrinsic(Page* _rp, Page* _ep) {
        ...
        auto success_intrinsic_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[18]);
    ...
    Result<ExtendsSyntax, ParserError> parse_extends(Page* _rp, Page* _ep) {
        ...
        auto success_extends_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[8]);
    ...
    Result<MacroSyntax, ParserError> parse_macro(Page* _rp, Page* _ep) {
        ...
        auto success_macro_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[23]);
        if (!success_macro_1) {
    ...
    Result<ModuleSyntax, ParserError> parse_module(Page* _rp, Page* _ep) {
        ...
        auto success_module_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[25]);
        if (!success_module_1) {
    ...
    Result<ExpressionSyntax, ParserError> parse_expression(Page* _rp, Page* _ep) {
        ...
        }
        {
            ...
            else
            {
                auto node = node_result._Ok;
                return Result<ExpressionSyntax, ParserError> { ._tag = Result<ExpressionSyntax, ParserError>::Ok, ._Ok = 
                    ExpressionSyntax(TrySyntax(node))
                };
            }
        }
        {
        ...
        {
            auto node_result = this->parse_is(_rp, _ep);
            if (node_result._tag == Result<IsSyntax, ParserError>::Error)
            {
                if (node_result._Error._tag == ParserError::InvalidSyntax)
                    return Result<ExpressionSyntax, ParserError> { ._tag = Result<ExpressionSyntax, ParserError>::Error, ._Error = node_result._Error };
            }
            else
            {
                auto node = node_result._Ok;
                return Result<ExpressionSyntax, ParserError> { ._tag = Result<ExpressionSyntax, ParserError>::Ok, ._Ok = 
                    ExpressionSyntax(IsSyntax(node))
                };
            }
        }
    ...
    Result<IfSyntax, ParserError> parse_if(Page* _rp, Page* _ep) {
        ...
        auto success_if_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[12]);
        if (!success_if_1) {
    ...
    Result<ElseSyntax, ParserError> parse_else(Page* _rp, Page* _ep) {
        ...
        auto success_else_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[7]);
        if (!success_else_1) {
    ...
    Result<MatchSyntax, ParserError> parse_match(Page* _rp, Page* _ep) {
        ...
        auto success_match_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[24]);
        if (!success_match_1) {
        ...
        auto branches_start = this->lexer.position;
        auto branches_result = this->parse_branch_list(_rp, _ep);
        if (branches_result._tag == Result<Vector<BranchSyntax>, ParserError>::Error)
        {
            switch (branches_result._Error._tag) {
                case ParserError::DifferentSyntax:
                    return Result<MatchSyntax, ParserError> { ._tag = Result<MatchSyntax, ParserError>::Error, ._Error = ParserError(InvalidSyntax(branches_start, lexer.position, String(_ep, "a valid Branch syntax"))) };
                case ParserError::InvalidSyntax:
                    return Result<MatchSyntax, ParserError> { ._tag = Result<MatchSyntax, ParserError>::Error, ._Error = branches_result._Error };
            }
        }

        auto branches = branches_result._Ok;
        ...
        auto ret = MatchSyntax(start, end, scrutinee, branches, alternative);

        return Result<MatchSyntax, ParserError> { ._tag = Result<MatchSyntax, ParserError>::Ok, ._Ok = ret };
    }

    Result<Vector<BranchSyntax>*, ParserError> parse_branch_list(Page* _rp, Page* _ep) {
        Region _r;
        List<BranchSyntax>& list = *new(alignof(List<BranchSyntax>), _r.get_page()) List<BranchSyntax>();;
        while(true) {
            auto node_result = this->parse_branch(_rp, _ep);
    ...
    Result<BranchSyntax, ParserError> parse_branch(Page* _rp, Page* _ep) {
        auto start = this->lexer.previous_position;
        ...
        {
            return Result<BranchSyntax, ParserError> { ._tag = Result<BranchSyntax, ParserError>::Error, ._Error = cases_result._Error };
        }
        ...
        if (consequent_result._tag == Result<StatementSyntax, ParserError>::Error)
        {
            switch (consequent_result._Error._tag) {
                case ParserError::DifferentSyntax:
                    return Result<BranchSyntax, ParserError> { ._tag = Result<BranchSyntax, ParserError>::Error, ._Error = ParserError(InvalidSyntax(consequent_start, lexer.position, String(_ep, "a valid Statement syntax"))) };
                case ParserError::InvalidSyntax:
                    return Result<BranchSyntax, ParserError> { ._tag = Result<BranchSyntax, ParserError>::Error, ._Error = consequent_result._Error };
            }
        }
        ...
        auto ret = BranchSyntax(start, end, cases, consequent);
    ...
    Result<CaseSyntax, ParserError> parse_case(Page* _rp, Page* _ep) {
        ...
        auto success_case_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[1]);
        if (!success_case_1) {
        ...
        auto ret = CaseSyntax(start, end, condition);
    ...
    Result<ChooseSyntax, ParserError> parse_choose(Page* _rp, Page* _ep) {
        ...
        auto success_choose_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[2]);
        if (!success_choose_1) {
        ...
        if (condition_result._tag == Result<Vector<OperandSyntax>, ParserError>::Error)
        {
            switch (condition_result._Error._tag) {
                case ParserError::DifferentSyntax:
                    return Result<ChooseSyntax, ParserError> { ._tag = Result<ChooseSyntax, ParserError>::Error, ._Error = ParserError(InvalidSyntax(condition_start, lexer.position, String(_ep, "a valid Operand syntax"))) };
                case ParserError::InvalidSyntax:
        ...
        auto ret = ChooseSyntax(start, end, condition, cases, alternative);
    ...
    Result<TrySyntax, ParserError> parse_try(Page* _rp, Page* _ep) {
        ...
        auto success_try_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[38]);
        if (!success_try_1) {
        ...
        if (cases_result._tag == Result<Vector<WhenSyntax>, ParserError>::Error)
        {
            switch (cases_result._Error._tag) {
                case ParserError::DifferentSyntax:
                    break;
                case ParserError::InvalidSyntax:
                    return Result<TrySyntax, ParserError> { ._tag = Result<TrySyntax, ParserError>::Error, ._Error = cases_result._Error };
            }
        }
        ...
        auto dropper_result = this->parse_else(_rp, _ep);
        if (dropper_result._tag == Result<ElseSyntax, ParserError>::Error)
        {
        ...
        ElseSyntax* dropper = dropper_result._tag == Result<ElseSyntax, ParserError>::Error ? nullptr : new(alignof(ElseSyntax), _rp) ElseSyntax(dropper_result._Ok);

        auto end = this->lexer.position;

        auto ret = TrySyntax(start, end, condition, cases, dropper);
    ...
    Result<WhenSyntax, ParserError> parse_when(Page* _rp, Page* _ep) {
        ...
        auto success_when_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[42]);
        if (!success_when_1) {
    ...
    Result<LetSyntax, ParserError> parse_let(Page* _rp, Page* _ep) {
        ...
        auto success_let_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[21]);
        if (!success_let_1) {
    ...
    Result<MutableSyntax, ParserError> parse_mutable(Page* _rp, Page* _ep) {
        ...
        auto success_mutable_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[26]);
    ...
    Result<LoopSyntax, ParserError> parse_loop(Page* _rp, Page* _ep) {
        ...
        auto success_loop_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[22]);
        if (!success_loop_1) {
    ...
    Result<ReturnSyntax, ParserError> parse_return(Page* _rp, Page* _ep) {
        ...
        auto success_return_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[30]);
        if (!success_return_1) {
    ...
    Result<ThrowSyntax, ParserError> parse_throw(Page* _rp, Page* _ep) {
        ...
        auto success_throw_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[35]);
        if (!success_throw_1) {
    ...
    Result<LambdaSyntax, ParserError> parse_lambda(Page* _rp, Page* _ep) {
        ...
        auto success_lambda_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[20]);
        if (!success_lambda_1) {
    ...
    Result<ForSyntax, ParserError> parse_for(Page* _rp, Page* _ep) {
        ...
        auto success_for_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[10]);
        if (!success_for_1) {
        ...
        auto success_in_4 = this->lexer.parse_keyword(_rp, *this->keywords_index[16]);
        if (!success_in_4) {
    ...
    Result<LabelSyntax, ParserError> parse_label(Page* _rp, Page* _ep) {
        ...
        auto success_label_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[19]);
        if (!success_label_1) {
    ...
    Result<RepeatSyntax, ParserError> parse_repeat(Page* _rp, Page* _ep) {
        ...
        auto success_repeat_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[32]);
        if (!success_repeat_1) {
    ...
    Result<SetSyntax, ParserError> parse_set(Page* _rp, Page* _ep) {
        ...
        auto success_set_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[33]);
        if (!success_set_1) {
    ...
    Result<SizeOfSyntax, ParserError> parse_sizeof(Page* _rp, Page* _ep) {
        ...
        auto success_sizeof_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[34]);
        if (!success_sizeof_1) {
    ...
    Result<IsSyntax, ParserError> parse_is(Page* _rp, Page* _ep) {
        ...
        auto success_is_1 = this->lexer.parse_keyword(_rp, *this->keywords_index[13]);
        if (!success_is_1) {
            return Result<IsSyntax, ParserError> { ._tag = Result<IsSyntax, ParserError>::Error, ._Error = ParserError(DifferentSyntax()) };
        }
        ...
        if (name_result._tag == Result<NameSyntax, ParserError>::Error)
        {
            switch (name_result._Error._tag) {
                case ParserError::DifferentSyntax:
                    return Result<IsSyntax, ParserError> { ._tag = Result<IsSyntax, ParserError>::Error, ._Error = ParserError(InvalidSyntax(name_start, lexer.position, String(_ep, "a valid Name syntax"))) };
                case ParserError::InvalidSyntax:
                    return Result<IsSyntax, ParserError> { ._tag = Result<IsSyntax, ParserError>::Error, ._Error = name_result._Error };
            }
        }
        ...
        auto ret = IsSyntax(start, end, name);
